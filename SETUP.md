...
2. Abra esta pasta (`db-mcp`) no Claude Code.
3. Peça:

   > "Instala o db-mcp apontando pro meu banco."

O Claude executa a skill `setup-db-mcp`, que pergunta os parâmetros do seu
...
`uv run db-mcp doctor` interpretando cada checagem, e registra o MCP no seu
